  ...
  const externalSessionCenterSurface = (
    <ExternalSessionCenter
      ...
      copy={{
        ...
        authenticationRequiredTitle: t("externalSessionsAuthenticationRequiredTitle"),
        authenticationRequiredBody: t("externalSessionsAuthenticationRequiredBody"),
        authenticationRetry: t("externalSessionsAuthenticationRetry"),
        ...
        terminalKeyConfirm: t("externalSessionsTerminalKeyConfirm"),
        terminalKeyCancel: t("externalSessionsTerminalKeyCancel"),
        terminalKeyUp: t("externalSessionsTerminalKeyUp"),
        terminalKeyDown: t("externalSessionsTerminalKeyDown"),
        terminalKeySwitch: t("externalSessionsTerminalKeySwitch"),
        terminalKeyInterrupt: t("externalSessionsTerminalKeyInterrupt"),
        terminalKeySent: t("externalSessionsTerminalKeySent"),
        terminalInterruptSent: t("externalSessionsTerminalInterruptSent"),
        sourceStates: {
          ready: t("externalSourceReady"),
          adapter_required: t("externalSourceAdapterRequired"),
          not_installed: t("externalSourceNotInstalled"),
